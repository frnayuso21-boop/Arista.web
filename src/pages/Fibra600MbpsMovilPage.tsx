...
const Fibra600MbpsMovilPage: React.FC<Fibra600MbpsMovilPageProps> = ({ onBack }) => {
  ...
  const getBasePrice = () => 30.00; // Precio base fibra 600
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        ...
        <div className="flex items-center space-x-2 text-white/70 mb-8">
          ...
          <span>/</span>
          <span className="text-white">Fibra 600 Mbps + Móvil</span>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto" style={{
            ...
            Velocidad superior para usuarios exigentes y familias conectadas
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 max-w-md mx-auto mb-8">
            <div className="text-center">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-white appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-400"
                  >
              ...
              <div className="text-5xl font-bold text-purple-400 mb-2">{getTotalPrice().toFixed(2)}€</div>
              <div className="text-white/70 text-lg mb-4">/mes</div>
              <div className="text-sm text-white/60 mb-4">
                Fibra 600 Mbps: {getBasePrice()}€ + Móvil {movilOptions.find(opt => opt.id === selectedMovilGB)?.name}: {getMovilPrice()}€ - Descuento: 5€
              </div>
              <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-3 mb-6">
                ...
                <p className="text-green-300 text-xs">Ahorro de 5€/mes por fibra + móvil</p>
              </div>
              <button
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <Wifi className="w-6 h-6 text-purple-400 mr-3" />
              Fibra Óptica Premium
            </h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-white/80">Velocidad</span>
                <span className="text-white font-semibold">600 Mbps simétrica</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-white font-semibold">WiFi 6 Pro incluido</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-white font-semibold">5G Premium</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Streaming 4K simultáneo</h3>
                  <p className="text-white/80 text-sm">Disfruta de múltiples contenidos en 4K sin interrupciones</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <Star className="w-5 h-5 text-yellow-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-white font-semibold mb-1">Gaming sin lag</h3>
                  <p className="text-white/80 text-sm">Latencia mínima para gaming online competitivo</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <Star className="w-5 h-5 text-yellow-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-white font-semibold mb-1">Teletrabajo profesional</h3>
                  <p className="text-white/80 text-sm">Videoconferencias HD y subida rápida de archivos</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <Star className="w-5 h-5 text-yellow-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-white font-semibold mb-1">Hogar conectado</h3>
                  <p className="text-white/80 text-sm">Perfecto para casas inteligentes con múltiples dispositivos</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center">
            ...
            <p className="text-white/70 text-sm">Gratuita y prioritaria</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center">
            <Shield className="w-8 h-8 text-green-400 mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-2">Cobertura</h3>
            <p className="text-white/70 text-sm">Nacional 5G Premium</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center">
            <Users className="w-8 h-8 text-purple-400 mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-2">Soporte</h3>
            <p className="text-white/70 text-sm">24/7 prioritario</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30 rounded-2xl p-8 text-center mb-16">
          <h2 className="text-2xl font-bold text-white mb-4">
            Experimenta la velocidad premium
          </h2>
          <p className="text-white/80 mb-6 max-w-2xl mx-auto">
            Únete a la experiencia premium con 600 Mbps de velocidad pura y conectividad 5G de última generación
          </p>
...
export default Fibra600MbpsMovilPage;